...
<head>
	...
	<script src="<?php echo base_url()?>public/common/theme/scripts/plugins/system/less.min.js"></script>
		...
		<!-- DataTables Plugin -->
	<link href="<?php echo base_url()?>public/common/theme/scripts/plugins/tables/DataTables/media/css/DT_bootstrap.css" rel="stylesheet" />
</head>
<body class="login">
...
<?php $this->load->view('admin/template/header');?>
	...
	<div id="wrapper">
	<?php $this->load->view('admin/template/left_bar');?>
		 <div id="content">
	...
	<script src="<?php echo base_url()?>public/js/listing.js"></script>
	...
	<script src="<?php echo base_url()?>public/common/theme/scripts/plugins/tables/DataTables/media/js/jquery.dataTables.min.js"></script>
	<script src="<?php echo base_url()?>public/common/theme/scripts/plugins/tables/DataTables/media/js/DT_bootstrap.js"></script>
	
	<!-- Tables Demo Script -->
	<script src="<?php echo base_url()?>public/common/theme/scripts/demo/tables.js"></script>
