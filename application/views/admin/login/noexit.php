...
{ ?>
 ...
 <?php } ?>
<form method="post" action="<?php echo base_url(); ?>index.php/admin/login/deletenoexit"?> 
...
$date=date('h:i:s a',strtotime($r['created_date']));
...
<td><?php echo $date; ?>&nbsp;/&nbsp;<?php echo $r['updateddate']; ?></td> 
